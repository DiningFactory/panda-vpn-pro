...
- 🗓️ 2025.10.23 🗓️ `SAC` 的用户请注意，该机场官网其中一个域名突然无法访问，与此同时，其社群管理员（机场主）已删除账号（无法确定是主动注销还是被封号），存在一定跑路（或被迫跑路）的风险，暂不建议购买或续费。跑路是否实锤有待继续观察。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ~~2019.03.17~~ | ~~[SAC](https://sachk.189.cam/register?code=1YIbUxet)~~<br>暂存跑路风险 | ~~中转~~ | ~~1 & 1.3~~ | ~~9.99 / 100 GB~~ | ~~199.99 / 1000 GB~~ | ~~Null~~ | ~~Null~~ |
