...
- 🗓️ 2025.11.24 🗓️ `M78星云` 的用户请注意，该机场近期新增了 `Vless` 协议的直连节点（我已在机场列表添加 `V` 标识）用于防失联，但是一些过于老旧的代理软件会由于不支持该协议而无法导入订阅（比如 `Clash for Windows`），如你所使用的代理软件不支持该协议，建议尽快更换为其他代理软件。此通知将于 12.15 删除。
- 🗓️ 2025.11.24 🗓️ 今天下午多家机场的节点域名被污染，以至于节点无法使用。如你发现机场节点大面积飘红，请更新订阅（注：阅后即焚的机场需前往官网重新复制订阅链接）。更新后如果问题依旧，那就过段时间再更新（需要等待机场主更换节点域名）。此通知暂定 12.15 删除。🗓️ 2025.11.26 🗓️ 这两天依然存在域名污染的情况，有点之前频繁通报那味了。如果这个也常态化了，那就真是雪上加霜了。但也不要过度紧张，有待继续观察。
- 🗓️ 2025.11.27 🗓️ `次元云` 的用户请注意，该机场已使用阅后即焚模式（我已在机场列表添加 🔥 标识）。此通知将于 12.15 删除。🗓️ 2025.12.04 🗓️ 目前已取消阅后即焚（我已删除相应标识）。
- 🗓️ 2025.12.02 🗓️ `一分机场` 的用户请注意，该机场目前突发一些状况，如：订阅链接无法导入或更新，大量节点不可用。但暂无跑路风险，无需担心，等待修复即可。另外，还有许多掉单（付费成功后账户里的套餐没有任何变化）问题，如有遇到，等待恢复后可在官网发工单找机场主补单。为防止产生更多掉单，目前该机场已暂时关闭支付。🗓️ 2025.12.02 🗓️ 已基本恢复（不同地区解析速度不一样，有些地方可能需要再过一段时间才能正常使用）。此通知将于 12.15 删除。
- 🗓️ 2025.12.07 🗓️ `壹速云` 的用户请注意，该机场近期持续遭受攻击，以至于节点体验不佳，暂不推荐购买或续费。此通知将于恢复正常一段时间后删除。
...
| 2019.08.15 | 🟨<br>[壹速云](https://www.onesy1.cc/auth/register?code=R4Lm) | 中转 | 1 | 10.90 / 150 GB | 188.00 / 1000 GB | Null | Null |
| 2020.04.22 | [次元雲](https://ciyy.me/#/register?code=tsL8Me6h) | 中转 | 1 | 10.00 / 128 GB | 85.00 / 520 GB | Null | Null |
| 2022.09.01 | [Metcha](https://ww1.638242.xyz/#/register?code=MzTl1fEj) | 中转 | 1 | 9.88 / 128 GB | 18.88 / 128 GB | Null | Null |
...
| 2023.02.03 | [自由猫](https://us.freecat.cloud/register?code=8S3V1vsr) | 中转 | 1 | 9.00 / 100 GB | 50.00 / 500 GB | Null | 6.8 折<br>`20251212`<br>所有套餐可用<br>12.12 前有效<br><br>8 折<br>`FREECAT`<br>所有套餐可用<br>限用一次<br>长期有效 |
| 2023.05.01 | [农夫山泉](https://www.nfsq.us/#/register?code=HvoPMFli)<br>🔥🔥<br>`*V` | 中转 | 1 | 8.00 / 200 GB | 15.00 / 200 GB | Null | Null |
| 2023.07.01 | [蜂窝云](https://api.fwcloud.life/auth/register?code=DZzGx5)<br>🔥<br>`V` | 中转 | 0.5 & 1 | 20.00 / 200 GB | 40.00 / 210 GB | Null | 8 折<br>`1212`<br>所有套餐可用<br>7 折<br>`Y1212`<br>年付套餐可用<br>12.15 前有效<br><br>`FW9`<br>所有套餐可用<br>长期有效 |
| 2023.09.12 | [M78星云](https://m78star.cloud/#/register?code=7IWr2dOP)<br>🔥<br>`V` | 中转 | 1 |  7.80 / 80 GB | 99.00 / 400 GB | Null | Null |
| ~~2023.09.23~~ | 🟨<br>~~[云安云](https://yay520.com/login/?code=zE8rnA2S)~~<br>🔥 | ~~中转~~ | ~~1~~ | ~~7.00 / 120 GB~~ | ~~25.00 / 118 GB~~ | ~~Null~~ | ~~Null~~ |
...
| 2025.03.07 | [ofoNET](https://q.ofo.baby/#/register?code=q3kx6Xt9) | 中转 | 1 | 15.00 / 150 GB | 49.00 / 150 GB | Null | 8 折<br>`ofonet8`<br>所有套餐可用<br>短期有效 |
...
| :---: | :---: |
| ~~SAC~~ | ~~移动：广东广州~~ |
| 壹速云 | 电信：广东深圳<br>联通：广东深圳<br>移动：四川遂宁 |
| 次元雲 | 电信：福建泉州<br>移动：广东东莞，广东深圳 |
| Metcha | 电信：广东广州，广东深圳<br>联通：广东佛山<br>移动：广东广州，广东江门 |
| 自由猫 | 移动：广东深圳，广东广州 |
| 农夫山泉 | 电信：广东广州<br>联通：广东佛山<br>移动：广东汕尾 |
| 蜂窝云 | 电信：广东东莞<br>联通：广东广州<br>移动：广东深圳 |
| M78星云 | 电信：广东广州<br>联通：广东佛山<br>移动：广州广州，广东深圳 |
| ~~云安云~~ | ~~联通：山东青岛~~ |
| 兔兔云 | 移动：广东江门 |
| Doriya | 电信：湖北襄阳，福建泉州，广东深圳<br>联通：湖北襄阳，广东广州<br>移动：湖北襄阳，广东深圳，广东广州 |
| FlyBit | 电信：广东广州<br>联通：广东深圳<br>移动：广东深圳<br>阿里云：四川成都，浙江杭州 |
| NyanSS | 移动：广东广州 |
| ofoNet | 电信：福建泉州<br>移动：山东济南 |
