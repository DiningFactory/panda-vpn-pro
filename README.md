...
- 🗓️ 2026.02.27 🗓️ `农夫山泉` 的用户请注意，该机场目前正遭受攻击，官网无法访问，且所有节点都处于不可用的状态，存在一定跑路风险（看老板能不能承受住压力了）。此通知将于恢复后删除。🗓️ 2026.02.27 🗓️ 目前官网时不时会恢复，但节点仍持续遭受攻击。
...
| 2023.05.01 | 🟨<br>[农夫山泉](https://www.nfsqttt.com/#/register?code=HvoPMFli)<br>🔥🔥<br>`*V`<br>被攻击中<br>暂不推荐 | 中转 | 1 | 8.00 / 200 GB | 15.00 / 200 GB | Null | Null |
