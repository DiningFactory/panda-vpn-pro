...
> 注意，有些时候官网发生某些变动时会导致节点几乎或是完全不能用，此时更新订阅不一定有效，而需要手动重置订阅（其实这种情况一般进入官网重新复制订阅链接就好了，但稳妥起见，在复制链接前先重置一遍会更好。重置链接没有任何坏处，甚至有好处。比如你若曾在不知情的情况下把自己的订阅链接泄漏出去，你的流量就会别人盗用。而重置订阅链接之后，别人就用不了了），即下面的第四点。
