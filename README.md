...
📢 **重要通知**：此部分仅用于对本项目以及机场的“重要变动”或“突发情况”作出必要的说明。
 ...
 - 🗓️ 2024.11.24 🗓️ `喵喵云` 机场已将节点倍率调整为 0.5 倍（注：节点倍率代表的是消耗流量的速度，非节点的下载速度）（🗓️ 2024.11.30 🗓️：目前大约有一半节点的倍率下调为 0.4。🗓️ 2024.12.09 🗓️ 0.4 倍率的节点下调至 0.3），大约会在 12.31 后恢复为常规的 1 倍率，由于该调整为临时性的，为防止产生误导，此部分通知将于节点倍率恢复为 1 时删除。
