...
- 🗓️ 2026.04.24 🗓️ 在昨日，有小道消息称“中国联通、移动、电信运营商对海外方向均报告网络故障”，具体内容及来源此处就不提供了，因为内容较长且依旧为非官方消息。具体表现就是一些用户几乎无法使用直连节点（要么完全用不了，要么频繁频繁断流，要么速度接近 0），具体影响范围无法统计，有些地区完全无感，有些地区则出现了上述情况。截至目前可观察到的情况是：移动的数据流量最受影响，移动的宽带流量次之，电信与联通基本不受影响。不同协议的影响也不同，如 `IPv4` 和 `TCP` 流量受影响较大，`IPv6` 和 `UDP` 则影响较小。昨日没发通知是因为我本以为只是个普通的故障，但现在问题已超过 24 小时，或许并不是简单的故障。至于事情会怎么发展就没必要猜了，让子弹再飞一会吧，此通知暂不删除。
- 🗓️ 2026.04.28 🗓️ 机场圈赫赫有名的快连 VPN 已宣布停止中国大陆地区的业务运营（虽名为 VPN，但本质跟机场没大区别，就像近期一些强制使用客户端的机场）。尽管它并不存在本文的推荐列表中，但我还是想哔哔几句，毕竟，它还是很有代表性的。所谓代表性并不是它多好，而是它的存活时间（2019 至今）和知名度（广告投放量极多）太夸张了。就这两者而言，它说第二，没人敢说第一。虽然它的性价比极低（插个题外话：作为本人接触的第二款付费 VPN，但凡它便宜些或不限制 2 个设备，也许本文就不会诞生，也许今日我也是众多难民之一），口碑也不怎么样，但是论“活”这件事情，基本不会有人质疑它，甚至很多传言认为其是有背景的钓鱼 VPN，才能存活这么久。然而即使“命硬”如快连，在这一年里的各种持续打压下（通报，攻击，拔线等），也终究挺不住。因此，我决定将此事件作为“**任何机场都会跑路的标准教材**”，不要以为“老牌”和“贵”就能经久不衰。**深情往往被辜负**，**任何翻墙服务都不值得你年付**。此通知将于 5.15 移至“大事留档”。
...
| 2023.02.03 | 🟨<br>[自由猫](https://us.freecat.cloud/register?code=8S3V1vsr) | 中转 | 1 | 9.00 / 100 GB | 50.00 / 500 GB | Null | 6.8 折<br>`20260501`<br>所有套餐可用<br>5.5 前有效<br><br>8 折<br>`FREECAT`<br>所有套餐可用<br>限用一次<br>长期有效 |
...
| 2023.07.01 | 🟨<br>[蜂窝云](https://api.fwcloud.life/auth/register?code=DZzGx5)<br>🔒<br>📜 | 中转 | 0.5 & 1 | 20.00 / 200 GB | Null | Null | 7 折<br>`FW51`<br>所有套餐可用<br>5.14 前有效<br><br>9 折<br>`FW9`<br>所有套餐可用<br>长期有效 |
| 2023.09.12 | 🟨<br>[M78星云](https://m78star.cloud/#/register?code=7IWr2dOP)<br>`A`<br>🔒<br>📜 | 中转 | 1 |  7.80 / 80 GB | 99.00 / 400 GB | Null | 85 折<br>`season85`<br>季付套餐可用<br>82 折<br>`halfyear82`<br>半年付套餐可用<br>8 折<br>`year80`<br>年付套餐可用<br>5.10 前有效 |
