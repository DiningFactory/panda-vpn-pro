...
- 🗓️ 2026.04.24 🗓️ 在昨日，有小道消息称“中国联通、移动、电信运营商对海外方向均报告网络故障”，具体内容及来源此处就不提供了，因为内容较长且依旧为非官方消息。具体表现就是大量用户几乎无法使用直连节点（要么完全用不了，要么频繁频繁断流，要么速度接近 0），具体影响范围无法统计，有些地区完全无感，有些地区则出现了上述情况。截至目前可观察到的情况是：移动的数据流量最受影响，移动的宽带流量次之，电信与联通基本不受影响。不同协议的影响也不同，如 `IPv4` 和 `TCP` 流量受影响较大，`IPv6` 和 `UDP` 则影响较小。昨日没发通知是因为我本以为只是个普通的故障，但现在问题已超过 24 小时，或许并不是简单的故障。至于事情会怎么发展就没必要猜了，让子弹再飞一会吧，此通知暂不删除。
