...
- 🗓️ 2025.08.20 🗓️ 目前 GFW 对大量（也可能是所有）国外 `443` 端口的流量进行了屏蔽（双向屏蔽，即“内外”几乎无法互相访问），`ipv6` 暂时几乎没影响。比如无法在不挂梯子且无 `ipv6` 的情况下访问苹果的 [官网](https://www.apple.com/) 。有说是为了 9.3 阅兵做准备，也有说是配置失误等，真实原因未知。对机场的影响主要是无法在不挂代理的情况访问官网或是更新订阅。
