...
- 🗓️ 2026.07.05 🗓️ `鱼鱼` 的用户请注意，该机场目前大部分节点都处于不可用的状态，原因未知，暂无太大跑路风险，等待修复即可。此通知将于恢复后删除。🗓️ 2026.07.06 🗓️ 目前已恢复，但又未完全恢复（少了许多节点），暂不建议购买，有待继续观察。🗓️ 2026.07.08 🗓️ 所有节点再次不可用。🗓️ 2026.07.08 🗓️ 再次恢复（依旧少了许多节点）。另外，个人认为机场主近期对机场的维护变得过于佛系了，因此暂停推荐（观察一段时间后会考虑重新推荐）。此通知以及该机场的链接将于 7.20 删除。
