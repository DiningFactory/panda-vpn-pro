...
- 🗓️ 2025.03.05 🗓️ 使用 clash 类内核的用户请注意：近期 GFW 屏蔽了国外的非域名类型的 DoH（DNS over HTTPS） 以及 DoT（DNS over TLS），如果机场的配置文件使用了相应的 DNS，那么可能会导致所有节点就无法连通，该状况预计持续至两会结束。若出现了该问题，可参考以下几种解决方式：
  1. Clash Meta：Settings（设置）--> Override（覆写）--> Strategy（策略）--> Use Built-in（使用内置）。
  2. Clash for Windows：右键机场配置文件，Edit（编辑）--> 找到 feedback 字段，在其值中修改 DNS。（更新配置文件后需要重复该操作，若不希望如此，一开始不要选择 Edit，而是选择 Diff）
  3. 更换非 clash 类内核的代理软件，如 v2ray 内核或者 sing-box 内核。（这是我最推荐的方式，也是我正文中提到的有备用代理软件的好处）
...
| 2022.12.07 | [一分机场](https://xn--4gqx1hgtfdmt.com/#/register?code=ziP4woeh)<br>`*VH` | 直连 | 0.1 | 2.00 / 100 GB | 19.88 / 1000 GB | Null | 8.8 折<br>`祝女神节大家永远二八`<br>所有套餐可用<br>3.10 前有效 |
...
| 2023.02.09 | [极速云](https://905.jsy902.xyz/#/register?code=4nCrjaUd) | 中转 | 8 | 12.99 / 1200 GB | 50.00 / 1000 GB | Null | Null |
...
| 2023.09.01 | [Metcha](https://ww1.638242.xyz/#/register?code=MzTl1fEj) | 中转 | 1 | 9.88 / 128 GB | 18.88 / 128 GB | Null | Null |
| 2023.09.12 | [M78星云](https://m78star.cloud/#/register?code=7IWr2dOP) | 中转 | 0.75 |  7.80 / 80 GB | 85.00 / 400 GB | Null | Null |
| 2024.03.01 | [Tutu](https://www.tutunbyy.uk/#/register?code=QKEtXiLs)<br>`H` | 中转 | 1 | 11.88 / 140 GB | 18.00 / 60 GB | 12 hours | Null |
| 2024.06.14 | [山水云](https://ccc.ssy614.com/#/register?code=k4V6l8b2) | 中转 | 1 | 9.00 / 100 GB | 45.00 / 150 GB | Null | 9 折<br>`998`<br>大部分套餐可用<br>长期有效 |
| 2024.08.14 | [喵喵云](https://v2.nyanss.com/register?code=dfsKFF7s) | 中转 | 0.2 | 7.50 / 50 GB | 25.00 / 100 GB | Null | 免费<br>`FreeTest1`<br>试用套餐可用<br>长期有效<br><br>8 折<br>`NYA2025`<br>所有套餐可用<br>长期有效 |
...
😟 购买了机场套餐后，有时会由于网络波动或者支付接口出现某些问题而导致“掉单”（**购买了套餐**，**但是没有生效或者依然显示未付款**），此时不必担心也不需要重新下单（注意，不要取消订单，否则可能会导致无法恢复，除非机场人员提示需要先取消订单），“**发起工单**”（此功能通常位于机场官网导航栏的“我的工单”中）**联系机场管理人员即可解决问题**。
