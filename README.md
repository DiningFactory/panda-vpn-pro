...
- 🗓️ 2025.10.15 🗓️ `蜂窝云` 的用户请注意，该机场已使用阅后即焚模式（我已在机场列表添加 🔥 标识），此后如需更新订阅，请前往官网重新获取。此通知将于 11.15 删除。
...
- 🗓️ 2025.11.05 🗓️ `云安云` 的用户请注意，该机场由于前阵子节点体验不佳，现在对周期用户补偿 15 天，但**需要手动提交工单**。此通知将于 12.1 删除。🗓️ 2025.11.05 🗓️ 目前所有节点再次处于不可用的状态，疑似被通报，暂无跑路风险，等待修复即可。🗓️ 2025.11.06 🗓️ 已恢复（注：需重新导入订阅）。
- 🗓️ 2025.11.07 🗓️ `NyanSS` 的用户请注意，该机场目前约一半节点处于不可用的状态，原因未知，暂无跑路风险，等待修复即可。此通知将于恢复后删除。
...
| 2020.04.22 | [次元雲](https://ciyy.me/#/register?code=tsL8Me6h) | 中转 | 1 | 10.00 / 128 GB | 85.00 / 500 GB | Null | 85 折<br>`20251111`<br>部分周期套餐可用<br>短期内有效 |
...
| 2023.09.23 | [云安云](https://yay520.com/login/?code=zE8rnA2S)<br>🔥 | 中转 | 1 | 7.00 / 120 GB | 25.00 / 118 GB | Null | 95 折<br>`2025100195`<br>月付套餐可用<br>88 折<br>`2025100188`<br>季 / 半年 / 不限时<br>套餐可用<br>78 折<br>`2025100178`<br>年付套餐可用<br>12.1 前有效 |
