...
- 🗓️ 2026.02.27 🗓️ `农夫山泉` 的用户请注意，该机场目前正遭受攻击，官网无法访问，且所有节点都处于不可用的状态，存在一定跑路风险（看老板能不能承受住压力了）。此通知暂不删除。🗓️ 2026.02.27 🗓️ 目前官网时不时会恢复，但节点仍持续遭受攻击。🗓️ 2026.03.01 🗓️ 目前该机场的官网与节点已恢复（但暂时还不是特别稳定，可能在做某些调整）。但是，为了防止攻击与通报，**已经改为强制使用客户端的方式了**（官网的“使用文档”中有客户端的下载说明），我已经给其添加 🔒 标识，正文上方也已新增该标识的具体说明。不过，这种强制客户端的方式肯定是有人不满意的，比如我自己就是不喜欢的。然而，在现在这种“外有通报，内有攻击”的情况下，我虽不支持，但也理解，没有被打跑路已经是不幸中的万幸（对机场圈关注较多的人应该知道，此次的攻击者这两年已经打跑了不少机场，尤其是小机场，因为防御成本是远高于攻击成本的，而小机场那点利润是上不了多强的防御的。大机场虽钱多能上防御，但其实也被折腾的够呛）。总之，如果实在介意的话，可在套餐用完后更换其他机场，又或者，尝试发工单要求退款，再或者，有钱任性直接不用了。话说回来，这种方式是否能有效防止攻击还有待继续观察，4.15 前若能保持基本稳定，此通知将删除。
...
| 2020.04.22 | [次元雲](https://ciyy.me/#/register?code=tsL8Me6h)<br>`V` | 中转 | 1 | 10.00 / 128 GB | 90.00 / 520 GB | Null | Null |
...
| 2023.07.01 | [蜂窝云](https://api.fwcloud.life/auth/register?code=DZzGx5)<br>🔥<br>`V` | 中转 | 0.5 & 1 | 20.00 / 200 GB | 40.00 / 210 GB | Null | 9 折<br>`FW9`<br>所有套餐可用<br>长期有效 |
