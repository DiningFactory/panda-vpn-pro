...
- 🗓️ 2026.06.19 🗓️ `NyanSS` 的用户请注意，该机场目前计划于 8 月份强制客户端。介意的请勿续费（购买）。此通知将于真正封端后删除（到时会为其添加 🔒 标识）。🗓️ 2026.08.02 🗓️ 截至目前尚未封端，8.15 前若依然没有封端，此通知将删除。
- 🗓️ 2026.07.23 🗓️ `壹速云` 的用户请注意，该机场目前正遭受攻击，大部分节点都处于不可用或不好用的状态，暂不推荐购买，此通知将于恢复后删除。
- 🗓️ 2026.08.12 🗓️ `蜂窝云` 的用户请注意，该机场近期稳定性较差，会时不时出现大批节点掉线的情况，原因未知，暂不推荐购买，此通知将于恢复后删除。🗓️ 2026.08.13 🗓️ 目前，该机场已将订阅改为阅后即焚制（注：这并不代表前面所提到的问题已解决。仍待继续观察），我已在机场列表中添加 🔥 标识。
...
| 2020.04.22 | [次元雲](https://ciyy.one/#/register?code=tsL8Me6h)<br>`A` | 中转 | 1 | 17.00 / 158 GB | 125.00 / 520 GB | Null | 7 折<br>`ciyy77`<br>大部分套餐可用<br> 8.20 前有效<br><br>6.8 折<br>`ciyy7777`<br>不限时套餐可用<br>限量 30 份 |
...
| 2023.07.01 | 🟨<br>[蜂窝云](https://api.fwcloud.life/auth/register?code=DZzGx5)<br>🔥<br>📜 | 中转 | 1 | 20.00 / 200 GB | Null | Null | 7 折<br>`IEPLerror`<br>所有套餐可用<br>长期有效 |
