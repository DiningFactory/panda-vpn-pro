...
- 🗓️ 2026.04.02 🗓️ 如上方通知所说，拔线文件可能是假的，但内容确实是真的。这两天机场圈相当动荡，大部分中转机场受此影响，体验大幅度下滑，节点大面积不可用也是屡见不鲜。因此，**至少未来一个月内**，**都强烈不建议购买或续费中转机场**，**只建议购买直连机场**。此通知暂不删除（在此通知存在期间，中转机场如有不稳定的情况，我不会为其添加 🟨 标识或通知，当前情况，默认全都如此。除非有跑路迹象，或是改为强制使用客户端等特殊情况，才会专门通知）。🗓️ 2026.04.09 🗓️ 部分中转机场近期已新增了直连节点以作应对，之后“拔线”如果力度加大或是持续时间较长，也许会有很多中转机场不得不转型为直连机场。但即使如此，在当前时期，我暂不会把他们的类型从“中转”改为“直连”。因为这个阶段我只推荐直连机场，而这些半路转型的，我不认为他们短期内能做得比原先就是搞直连的做得更好。🗓️ 2026.05.30 🗓️ GFW 这段时间暂无更进一步的动作，各机场的体验虽不及以前，但也逐渐趋向稳定。6.20 前若无什么大事发生，此通知以及下方 5.22 的通知将删除。
...
| 2020.04.22 | [次元雲](https://ciyy.one/#/register?code=tsL8Me6h)<br>`A` | 中转 | 1 | 17.00 / 158 GB | 99.00 / 520 GB | Null | 9 折<br>`ciyy-999`<br>季付套餐可用<br>8 折<br>`ciyy-80`<br>年付套餐可用<br>短期有效 |
