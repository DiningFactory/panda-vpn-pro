...
- 🗓️ 2026.02.26 🗓️ `次元雲` 的用户请注意，受通报影响，该机场目前大部分节点都处于不可用状态，暂无跑路风险，不用过于担心，此通知将于恢复后删除。
...
| 2020.04.22 | 🟨<br>[次元雲](https://ciyy.one/#/register?code=tsL8Me6h)<br>`V` | 中转 | 1 | 10.00 / 128 GB | 90.00 / 520 GB | Null | 7.8 折<br>`2026-78`<br>部分年付套餐可用<br>8 折<br>`2026-888`<br>所有套餐可用<br>2.28 前有效 |
