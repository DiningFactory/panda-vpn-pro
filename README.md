...
- 🗓️ 2025.09.30 🗓️ `极速云` 的用户请注意，该机场近期体验大不如前，虽然在通报频繁的当下，机场不稳定是难免的，但是该机场并没有很积极的维护，并且，其价格在本文所推的机场中属于较高的那一档位，这个表现显然是不合格的。因此，不再推荐该机场。后续其体验如果有回升且能持续稳定，会考虑重新推荐，但短期内不会，至少在半年以后。此通知以及该机场的链接将于 11.1 删除。
- 🗓️ 2025.10.15 🗓️ `蜂窝云` 的用户请注意，该机场已使用阅后即焚模式（我已在机场列表添加相应标识），此后如需更新订阅，请前往官网重新获取。此通知将于 11.15 删除。
- 🗓️ 2025.10.23 🗓️ `云安云` 的用户请注意，该机场目前所有节点都处于不可用的状态，原因未知，暂无太大跑路风险，等待修复即可。🗓️ 2025.10.23 🗓️ 目前已“半恢复”（可用但不好用）。此通知将于完全恢复后删除。
- 🗓️ 2025.10.23 🗓️ `SAC` 的用户请注意，该机场官网其中一个域名突然无法访问，与此同时，其社群管理员（机场主）已删除账号（无法确定是主动注销还是被封号），存在一定跑路（或被迫跑路）的风险，暂不建议购买或续费。跑路是否实锤有待继续观察。🗓️ 2025.10.28 🗓️ 目前该机场已经无法续费或购买（支付接口无法正常使用），节点约有 1/3 处于不可用状态，这些症状已持续几天，结合前面提到的，跑路可以说是十有八九了。虽然节点未完全挂，但没人维护的话早晚也会全挂。2026.01.01 前如果该机场仍然没有“复活”，此通知以及该机场的链接将删除。再再再再再次强调，任何机场都有跑路的可能性，永远不要年付！！！！如你们所见，即使是本文中“资历最老”的机场，也难以避免跑路的命运。
- 🗓️ 2025.10.24 🗓️ `农夫山泉` 的用户请注意，该机场已使用阅后即焚模式（我已在机场列表添加相应标识。注意，该机场的“阅后即焚”模式是真正意义上的“阅后即焚”，目前本文其余机场的“阅后即焚”在时间限制内，可多次导入，而**该机场的“阅后即焚”模式即使是在时间限制内也只能导入一次**。因此，其标识与其余的有所不同），此后如需更新订阅，请前往官网重新获取。此通知将于 12.1 删除。
- 🗓️ 2025.10.27 🗓️ `NyanSS` 的用户请注意，该机场目前约一半节点处于不可用状态，疑似入口被通报，暂无跑路风险，无需担心，等待修复即可。此通知将于恢复后删除。
- 🗓️ 2025.10.27 🗓️ `蜂窝云` 的用户请注意，该机场由于原线路发生故障而切换至备用线路，因此目前体验较差。此通知将于恢复正常后删除。
...
👇 **机场购前须知**：
 ...
 - 🔥：表示该机场的**订阅链接**使用了“**阅后即焚**”模式：指在官网复制订阅链接后，该订阅链接在一定时间内（一般为 5 分钟）可导入代理软件。超过该时间后，如果想导入代理软件，需要重新复制订阅链接（注意，这个时间不一定是从你复制那一刻算起的，不同机场的实现方式会有一定差异。如果复制后导入失败，那可能是正巧失效了，此时可以尝试刷新网页，再重新复制订阅链接）。因此，**导入订阅后**，**请勿再更新订阅**（因为有些代理软件在更新订阅时会先清除当前订阅的节点，而由于这种订阅是阅后即焚的，就会导致更新后节点全部消失，需要重新前往官网获取），**如果设置了自动更新订阅**，**也请关闭**（虽然我在之前的通知里说近期要勤更新订阅，但是“阅后即焚”模式是相反的，导入后就别再更新）。所谓“阅后即焚”模式是在 2025 年 7 月的“入口通报事件”中，为了防止订阅泄漏以至于入口被通报，由某一线机场率先使用，因为有着不错的效果（注意：**有效果不代表可以完全避免被通报**），所以有一些机场也在跟进该模式。但该模式也是有缺点的，那就是当节点发生变化时，需要重新到官网获取订阅链接，比较麻烦（**想保证使用最新节点可每天获取一次订阅。但其实也没必要这样，节点变化一般不会很频繁，等到节点不可用或体验不佳时再重新订阅即可**）。以及无法通过更新订阅来查看自己当前剩余流量，只能前往官网查看。如果无法接受这些缺点，请避开带有 🔥 标识的机场。
    - 🔥🔥：更严格的“阅后即焚”，或者说真正意义上的“阅后即焚”。上述的“阅后即焚”在限制时间内是可以多次导入的，而更严格的“阅后即焚”即使是在限制时间内，也只能导入一次。也就是说，假如你现在在官网获取了一个订阅链接，当你将其导入到某代理软件后，该订阅链接就会立即失效，之后如果你想导入到另一个代理软件，你需要到官网在再获取一次订阅链接才能导入。
 - 🟨：表示该机场近期**节点质量明显下降或是大量节点不可用**（一般我都会在文章顶部发出通知，提供该标识主要是防止有人没看通知。具体状况建议查看本文顶部的“重要通知”），原因可能是被攻击，被通报，线路故障等。当问题修复之后我会删除该标识（在此之前不建议购买相应机场），但如果迟迟没有恢复，我会考虑不再推荐相应机场。
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| ~~2019.03.17~~ | 🟨<br>~~[SAC](https://sachk.189.cam/register?code=1YIbUxet)~~<br>暂存跑路风险 | ~~中转~~ | ~~1 & 1.3~~ | ~~9.99 / 100 GB~~ | ~~199.99 / 1000 GB~~ | ~~Null~~ | ~~Null~~ |
...
| 2022.12.07 | [一分机场](https://xn--4gqx1hgtfdmt.com/#/register?code=ziP4woeh)<br>`*VH` | 直连 | 0.1 & 1 | 2.00 / 100 GB | 19.88 / 1000 GB | Null | 75 折<br>`国庆共欢乐`<br>所有套餐可用<br>10.31 前有效<br><br>充 100 送 10<br>充 200 送 30<br>注：非自动到账<br>需发工单提供<br>`202510010000XXXX`<br>格式的订单号<br>10.31 前有效 |
...
| 2023.07.01 | 🟨<br>[蜂窝云](https://api.fwcloud.life/auth/register?code=DZzGx5)<br>🔥<br>`V` | 中转 | 0.5 & 1 | 20.00 / 200 GB | 40.00 / 210 GB | Null | 9 折<br>`FW9`<br>所有套餐可用<br>长期有效 |
| 2023.09.12 | [M78星云](https://m78star.cloud/#/register?code=7IWr2dOP)<br>🔥 | 中转 | 1 |  7.80 / 80 GB | 88.00 / 400 GB | Null | Null |
| 2023.09.23 | 🟨<br>[云安云](https://yay520.com/login/?code=zE8rnA2S)<br>🔥 | 中转 | 1 | 7.00 / 120 GB | 25.00 / 118 GB | Null | 95 折<br>`2025100195`<br>月付套餐可用<br>88 折<br>`2025100188`<br>季 / 半年 / 不限时<br>套餐可用<br>78 折<br>`2025100178`<br>年付套餐可用<br>10.31 前有效 |
...
| 2025.03.07 | [ofoNET](https://q.ofo.baby/#/register?code=q3kx6Xt9) | 中转 | 1 | 15.00 / 100 GB | 39.00 / 100 GB | Null | 8 折<br>`ofonet8`<br>所有套餐可用<br>10.29 前有效 |
| 2025.03.14 | [iNetS](https://inets.io/#/register?code=YVUGJDrv)<br>`*V` | 直连<br>+ | 0.2 & 1 | 4.90 / 50 GB | Null | 7 days<br>极少节点 | Null |
...
| :---: | :---: |
| SAC | 移动：广东广州 |
| 壹速云 | 电信：广东广州<br>联通：广东广州<br>移动：广东广州，广东韶关 |
| 次元雲 | 电信：广东深圳<br>联通：湖北武汉<br>移动：广东东莞，江苏徐州 |
| Metcha | 电信：广东深圳，广东广州<br>移动：广东深圳，广东江门 |
| 自由猫 | 电信：广东广州<br>移动：广东广州，江苏徐州 |
| 极速云 | 移动：广东广州，广东深圳 |
| 农夫山泉 | 电信：广东深圳<br>联通：广东深圳<br>移动：广东深圳 |
| 蜂窝云 | 联通：广东深圳，福建厦门<br>移动：广东深圳<br>阿里云：广东广州，浙江杭州 |
| M78星云 | 联通：广东深圳，上海，福建厦门<br>移动：广州深圳，广东云浮，四川成都 |
| 云安云 | 阿里云：上海 |
| 兔兔云 | 电信：上海<br>移动：上海，四川成都，广东广州 |
| FlyBit | 电信：广东广州<br>移动：广东广州，广东深圳 |
