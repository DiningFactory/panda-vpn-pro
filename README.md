...
- 🗓️ 2025.09.13 🗓️ 前几天刚通知说近期已经很少有入口被通报了，于是就把置顶长达两个月的通报事件的通知移至“大事留档”。然而好景不长，最近通报又多了起来，也是被狠狠打脸了。既然防火墙大哥的脾气如此阴晴不定，那我们只能**常态化看待通报**了。但我依然觉得不用过度担忧，总有应对方法的，比如未来可能会有越来越多的机场使用“阅后即焚”模式（在正文的“机场列表”上方有介绍）。此通知将长期保留。🗓️ 2025.09.29 🗓️ 有些机场虽然未采用阅后即焚模式，但是在受到通报后，机场主是有可能会重置所有用户的订阅链接的。因此，如果你发现订阅无法更新，请重新到官网导入订阅。
...
👇 **机场购前须知**：
 ...
 - 名称带有 🔥 的表示该机场的**订阅链接**使用了“**阅后即焚**”模式：指在官网复制订阅链接后，该订阅链接在一定时间内（一般为 5 分钟）可导入代理软件。超过该时间后，如果想导入代理软件，需要重新复制订阅链接（注意，这个时间不是从你复制那一刻算起的。如果复制后导入失败，那可能是正巧失效了，此时可以尝试刷新网页，再重新复制订阅链接）。因此，**导入订阅后**，**请勿再更新订阅**（因为有些代理软件在更新订阅时会先清除当前订阅的节点，而由于这种订阅是阅后即焚的，就会导致更新后节点全部消失，需要重新前往官网获取），**如果设置了自动更新订阅**，**也请关闭**（虽然我在之前的通知里说近期要勤更新订阅，但是“阅后即焚”模式是相反的，导入后就别再更新）。所谓“阅后即焚”模式是在 2025 年 7 月的“入口通报事件”中，为了防止订阅泄漏以至于入口被通报，由某一线机场率先使用，因为有着不错的效果，所以有一些机场也在跟进该模式。但该模式也是有缺点的，那就是当节点发生变化时，需要重新到官网获取订阅链接，比较麻烦（**想保证使用最新节点可每天获取一次订阅。但其实也没必要这样，节点变化一般不会很频繁，等到节点不可用或体验不佳时再重新订阅即可**）。以及无法通过更新订阅来查看自己当前剩余流量，只能前往官网查看。如果无法接受这些缺点，请避开带有 🔥 标识的机场。
...
| 2020.04.22 | [次元雲](https://ciyy.cc/#/register?code=tsL8Me6h) | 中转 | 1 | 10.00 / 128 GB | 85.00 / 500 GB | Null | Null |
...
| 2023.07.01 | [蜂窝云](https://api.fwcloud.life/auth/register?code=DZzGx5)<br>`V` | 中转 | 0.5 & 1 | 20.00 / 188 GB | 40.00 / 210 GB | Null | 7 折<br>`G202510`<br>之后续费原价<br>所有套餐可用<br>8 折<br>`G202510x8`<br>之后续费同价<br>所有套餐可用<br>10.8 前有效<br><br>充 200 送 30<br>充 500 送 100<br>充 1000 送 300<br>10.8 前有效<br><br>9 折<br>`FW9`<br>所有套餐可用<br>长期有效 |
...
| 2025.03.18 | [良心云](https://xn--9kqz23b19z.com/#/register?code=61Ysg3dm)<br>`*VH` | 直连 | 1 | 2.00 / 100 GB | 21.00 / 1000 GB | Null | 7 折<br>`LXY`<br>所有套餐可用<br>9.29 ~ 10.7 有效 |
...
| 壹速云 | 移动：广东广州 |
| 次元雲 | 电信：湖北襄阳，广东深圳<br>联通：湖北襄阳<br>移动：湖北襄阳，广东深圳，江苏徐州 |
| Metcha | 电信：广东广州<br>联通：广东广州<br>移动：广东深圳，广东江门 |
| 自由猫 | 电信：北京<br>移动：广东深圳，广东韶关，江苏徐州 |
| 极速云 | 电信：广东广州<br>移动：广东广州 |
| 农夫山泉 | 电信：广东深圳<br>联通：广东深圳<br>移动：广东揭阳 |
| 蜂窝云 | 电信：广东深圳<br>联通：广东深圳<br>移动：广东广州 |
| M78星云 | 移动：广东广州，广东佛山，江苏徐州 |
| 云安云 | 移动：广东深圳 |
| 兔兔云 | 电信：上海<br>移动：广东广州 |
