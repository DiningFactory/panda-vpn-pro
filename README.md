...
- 🗓️ 2025.07.16 🗓️ `次元云` 的用户请注意，该机场所有节点均已支持解析为 `IPv6`。
...
- 🗓️ 2025.08.17 🗓️ `FlyBit` 的用户请注意，该机场由于近期入口通报，体验下降，已通过增加个人中心余额的方式进行补偿，不同套餐的补偿情况不一，具体补偿方案请前往官网查看（如未收到补偿，可发工单询问是否遗漏）。另外，因怀疑订阅泄漏，已重置所有用户的订阅链接，因此需要前往官网重新获取。此通知将于 9.1 删除。
