...
- 🗓️ 2025.10.24 🗓️ `农夫山泉` 的用户请注意，该机场已使用阅后即焚模式（我已在机场列表添加相应标识。注意，该机场的“阅后即焚”模式是真正意义上的“阅后即焚”，目前本文其余机场的“阅后即焚”在时间限制内，可多次导入，而该机场的“阅后即焚”模式即使是在时间限制内也只能导入一次。因此，其标识与其余的有所不同），此后如需更新订阅，请前往官网重新获取。此通知将于 11.15 删除。
