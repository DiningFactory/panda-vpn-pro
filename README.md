...
- 🗓️ 2025.11.05 🗓️ `云安云` 的用户请注意，该机场由于前阵子节点体验不佳，现在对周期用户补偿 15 天，但**需要手动提交工单**。此通知将于 12.1 删除。🗓️ 2025.11.05 🗓️ 目前所有节点再次处于不可用的状态，疑似被通报，暂无跑路风险，等待修复即可。🗓️ 2025.11.06 🗓️ 已恢复（注：需重新导入订阅）。🗓️ 2025.11.11 🗓️ 该机场近期体验依然一般（尤其是晚高峰），暂不推荐购买。🗓️ 2025.11.20 🗓️ 鉴于该机场近来的体验实在过于一般，即使之前补偿了半个月，但是没法保持一个相对稳定的状态，那补偿也没什么意义。近一个月我基本都在高强度使用这个机场，白天还算凑合，晚上一言难尽。虽然其价格在中转机场里是偏低的，但在没有攻击或通报之类的情况下（也许有，但是官方没有给出相应的通知，那我就视为没有），也不该表现那么差。当然了，不排除是我个人问题。但我自认为我的网络环境是很友好的，所以，如果连我都觉得不好，那多数人的体验就不会多好。总之，不再推荐该机场（后续如果能持续稳定，会考虑重新推荐，但半年内不会）。此通知以及该机场的链接将于 12.20 删除。
