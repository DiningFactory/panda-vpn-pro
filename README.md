...
- 🗓️ 2026.04.02 🗓️ 如上方通知所说，拔线文件可能是假的，但内容确实是真的。这两天机场圈相当动荡，大部分中转机场受此影响，体验大幅度下滑，节点大面积不可用也是屡见不鲜。因此，**至少未来一个月内**，**都强烈不建议购买或续费中转机场**，**只建议购买直连机场**。此通知暂不删除（在此通知存在期间，中转机场如有不稳定的情况，我不会为其添加 🟨 或通知，当前情况，默认全都如此。除非有跑路迹象，或是改为强制使用客户端等特殊情况，才会专门通知）。
