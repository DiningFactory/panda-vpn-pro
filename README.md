...
📢 **重要通知**：此部分仅用于对于机场的重要变动及突发情况作出必要的说明。
 ...
 - 🗓️ 2024.03.30 🗓️ 购买了 `流萤云` 机场的用户的请注意，此机场现已与 `Frost` 机场进行合并（准确的说是后者将前者收购了），但是账号里的内容（套餐及余额等）需要手动在 `Frost` 机场的官网进行提工单，待机场主迁移。具体步骤为，[点击此处](https://www.frostboutiques.top/#/register?code=XSWmt6KF)进入官网，然后注册账号，账号的邮箱最好与原先在 `流萤云` 的邮箱一致（但也非硬性要求，因为两个机场所支持的邮箱并不完全一致），注册完毕之后使用以下格式进行提交工单：`主题统一为：老套餐迁移。具体内容：1、计费类型（按时间/按流量) 2、套餐名称 3、付款周期（月付/季付/年付/一次性等） 4、付款账单（当时付款多少元）5、剩余时间（按时间计费套餐）/剩余流量（按流量计费套餐） 6、原账户是否有余额，若有则说明多少 7、此账号邮箱是否为原网站邮箱`。提交工单完毕之后等待机场主处理即可。不过，这家机场没有不限时套餐，如果原先是不限时套餐，转移后的有效期会变成一年。**工单最好在 2024.04.30 前提交**（`流萤云` 大概将于这个时候关闭）。此通知将于 2024.05.15 删除。
...
| 2020.07.02 | [次元雲](https://ciyy.cc/index.php#/register?code=4ClGtdDG) | 中转 | 0.8 | 10.00 / 128 GB | 158.00 / 1024 GB | None | None |
...
| 2022.11.06 | [赔钱机场](https://xn--mes358aby2apfg.com/#/register?code=lW0qemOm)<br>`*VH` | 直连 | 0.01 | 1.99 / 500 GB | 14.90 / 1000 GB | None | None |
...
| 2022.11.11 | [冲浪猫](https://b.msclm.net/#/register?code=d6os6Lzi) | 中转 | 1 | 15.00 / 200 GB | 72.99 / 384 GB | None | 8.8 折<br>`cmclm`<br>所有套餐可用<br>4.11 前有效 |
...
| 2023.02.09 | [极速云](https://44.jsy.lol/#/register?code=4nCrjaUd) | 中转 | 5 | 8.00 / 800 GB | 50.00 / 1000 GB | None | 88 / 年 / (999 GB / 月)<br>158 / 年 / (1998 GB / 月)<br>666 / 年 / (8888 GB / 月)<br>39 / 不限时 / 999 GB<br>99 / 不限时 / 2999 GB<br>288 / 不限时 / 10000 GB<br>4 折<br>`888`<br>月付套餐可用<br>短期有效 |
...
| 2023.07.01 | [蜂窝云](https://api.fwcloud.pro/auth/register?code=mnYBMQ) | 中转 | 1 | 10.00 / 200 GB | 22.00 / 200 GB | None | 9 折<br>`FW9`<br>所有套餐可用<br>5.1 前有效 | 
...
| 2023.11.30 | [小巫云](https://www.grey51.life/#/register?code=b6x4qNSX) | 中转 | 0.9 | None | 12.00 / 100 GB | None | 9 折<br>`sunday`<br>所有套餐可用<br>4.5 前有效 |
...
| 2024.01.12 | [Frost](https://www.frostboutiques.top/#/register?code=XSWmt6KF) | 中转 | 1 | 6.00 / 80 GB | 13.00 / 88 GB<br>实际时长一年 | 1 hours | 9 折`e9tb09De`<br>所有套餐可用<br>长期有效 |
