...
📢 **重要通知**：此部分仅用于对机场的重要变动及突发情况作出必要的说明。
 ...
 - 🗓️ 2024.11.18 🗓️ `Frost` 的用户请注意，该机场的节点目前虽然基本能够正常运行，但是机场主近期的维护频率明显降低，处于一种极度“摆烂”的状态，存在一定的跑路嫌疑，即使不会跑路，该机场的体验也可能会直线下降，因此，暂时不建议再续费或者购买。但鉴于该机场此前长期的综合表现还不错，所以我会再观察三个月，如果这期间能一直够保持稳定，将重新推荐该机场，反之则彻底不再推荐该机场。此通知将于 2025.2.20 删除。
...
| ~~2022.06.21~~ | ~~[Frost](https://www.twilightfrost.top/#/register?code=XSWmt6KF)~~ | ~~中转~~ | ~~1~~ | ~~12.00 / 168 GB~~ | ~~13.00 / 68 GB实际时长一年~~ | ~~1 hours~~ | ~~9 折<br>`e9tb09De`<br>所有套餐可用<br>长期有效~~ |
